...
- **[Technical Documentation](technical_documentation.md)** ΓÇö A deep dive into the system architecture, infrastructure code, and the Random Forest ML risk assessment model.
- **[Incident Report Example](incident_report.md)** ΓÇö A detailed, real-world example of an incident report generated by a SOC analyst based on the dashboard's telemetry during a simulated attack campaign.
